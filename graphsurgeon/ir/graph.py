...
from caffe2onnx.graphsurgeon.ir.tensor import Constant, Tensor, Variable
from caffe2onnx.graphsurgeon.logger import G_LOGGER, LogMode
    ...
    def fold_constants(
        ...
        *Note: Due to how this function is implemented, the graph must be exportable to ONNX,
        ...
        Returns:
            self
        """
        from caffe2onnx.graphsurgeon.exporters.onnx_exporter import dtype_to_onnx, export_onnx
