...
def __createMul(layer, nodename, inname, outname, input_shape):
    ...
    node = CaffeToOnnxNode(layer, nodename, "Mul", inname, outname, input_shape, output_shape)
    return node
...
def __createAdd(layer, nodename, inname, outname, input_shape):
    output_shape = [input_shape[0]]
    node = CaffeToOnnxNode(layer, nodename, "Add", inname, outname, input_shape, output_shape)
    return node
...
def __createMax(layer, nodename, inname, outname, input_shape):
    ...
    node = CaffeToOnnxNode(layer, nodename, "Max", inname, outname, input_shape, output_shape)
    return node
