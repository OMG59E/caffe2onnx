...
def get_flatten_output_shape(input_shape: List, attributes: Dict) -> List:
    shape = input_shape[0]
    input_prod = 1
...
def create_flatten_node(
    layer, node_name: str, input_names: List, output_name: List, input_shape: List
) -> onnx.NodeProto:
